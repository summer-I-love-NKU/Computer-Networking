...
/*******************************************************/
#define BUF_LEN 65410//2**16==65536
#define HEADER_LEN 10//头部长度
#define DATA_LEN 65400
// #define BUF_LEN 14010
// #define HEADER_LEN 10//头部长度
// #define DATA_LEN 14000
/*******************************************************/
/**GBN滑动窗
 * seq:16 0-15 
 * window:15
 * */
#define SEQ_SIZE 16//0 1 2 ...15
#define WINDOW_WIDTH 5 //GBN<=2**n-1 SR<=2**(n-1)
queue<char*> Send_Buf_Queue;
